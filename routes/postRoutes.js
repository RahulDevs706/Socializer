...
const { createPost, getPostsForHome, likePost, commentPost, getAPost, getCommentForAPost, deleteComment, deleteAPost, updatePost } = require('../controller/postController');
